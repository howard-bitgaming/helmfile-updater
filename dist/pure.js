  ...
  "node_modules/yaml/dist/stringify/stringifyPair.js"(exports2) {
    ...
    function stringifyPair({ key: key2, value: value2 }, ctx, onComment, onChompKeep) {
      ...
      if (simpleKeys) {
        ...
        if (identity.isCollection(key2)) {
          const msg = "With simple keys, collection cannot be used as a key value";
          throw new Error(msg);
        }
      }
      let explicitKey = !simpleKeys && (!key2 || keyComment && value2 == null && !ctx.inFlow || identity.isCollection(key2) || (identity.isScalar(key2) ? key2.type === Scalar.Scalar.BLOCK_FOLDED || key2.type === Scalar.Scalar.BLOCK_LITERAL : typeof key2 === "object"));
...
var require_addPairToJSMap = __commonJS({
  "node_modules/yaml/dist/nodes/addPairToJSMap.js"(exports2) {
    ...
    var toJS = require_toJS();
    var MERGE_KEY = "<<";
    function addPairToJSMap(ctx, map, { key: key2, value: value2 }) {
    ...
    var isMergeKey = (key2) => key2 === MERGE_KEY || identity.isScalar(key2) && key2.value === MERGE_KEY && (!key2.type || key2.type === Scalar.Scalar.PLAIN);
...
var require_YAMLMap = __commonJS({
  "node_modules/yaml/dist/nodes/YAMLMap.js"(exports2) {
    ...
    var YAMLMap = class extends Collection.Collection {
      ...
      static from(schema, obj, ctx) {
        ...
        const add = (key2, value2) => {
          ...
          if (value2 !== void 0 || keepUndefined)
            map.items.push(Pair.createPair(key2, value2, ctx));
        };
      ...
      set(key2, value2) {
        this.add(new Pair.Pair(key2, value2), true);
      }
      /**
    ...
    function createPairs(schema, iterable, ctx) {
      ...
      if (iterable && Symbol.iterator in Object(iterable))
        for (let it of iterable) {
          ...
          pairs2.items.push(Pair.createPair(key2, value2, ctx));
        }
      return pairs2;
    }
    var pairs = {
      ...
      toJSON(_, ctx) {
        ...
        for (const pair of this.items) {
          ...
          if (identity.isPair(pair)) {
            ...
            value2 = toJS.toJS(pair.value, key2, ctx);
          } else {
...
var require_Document = __commonJS({
  "node_modules/yaml/dist/doc/Document.js"(exports2) {
    ...
    var Document = class _Document {
       ...
       */
      createPair(key2, value2, options = {}) {
      ...
      set(key2, value2) {
        if (this.contents == null) {
          this.contents = Collection.collectionFromPath(this.schema, [key2], value2);
  ...
  "node_modules/yaml/dist/compose/resolve-block-map.js"(exports2) {
    ...
    function resolveBlockMap({ composeNode, composeEmptyNode }, ctx, bm, onError, tag) {
      ...
      for (const collItem of bm.items) {
        const { start, key: key2, sep, value: value2 } = collItem;
...
var require_cst_stringify = __commonJS({
  "node_modules/yaml/dist/parse/cst-stringify.js"(exports2) {
    ...
    function stringifyItem({ start, key: key2, sep, value: value2 }) {
      let res = "";
      for (const st of start)
        res += st.source;
      if (key2)
...
var require_conversions = __commonJS({
  "node_modules/color-convert/conversions.js"(exports2, module2) {
    ...
    convert.rgb.ansi16 = function(args2) {
      ...
      var g = args2[1];
      var b = args2[2];
      var value2 = 1 in arguments ? arguments[1] : convert.rgb.hsv(args2)[2];
...
var require_utils = __commonJS({
  "node_modules/args/lib/utils.js"(exports2, module2) {
    "use strict";
    ...
    module2.exports = {
      ...
      readOption(option) {
        let value2 = option.defaultValue;
        const contents = {};
...
`);
      ...
      runCommand(details, options) {
        ...
        if (process.platform === "win32") {
          ...
          args2.unshift(full);
          this.child = spawn(process.execPath, args2, {
            stdio: "inherit"
          });
        } else {
          this.child = spawn(full, args2, {
            stdio: "inherit"
          });
        }
...
var require_option = __commonJS({
  "node_modules/args/lib/option.js"(exports2, module2) {
    "use strict";
...
var require_options = __commonJS({
  "node_modules/args/lib/options.js"(exports2, module2) {
    "use strict";
...
var require_command = __commonJS({
  "node_modules/args/lib/command.js"(exports2, module2) {
    "use strict";
...
var require_lib = __commonJS({
  "node_modules/mri/lib/index.js"(exports2, module2) {
    function toArr(any) {
    ...
    module2.exports = function(args2, opts) {
      ...
      opts.boolean.forEach((key2) => {
        opts.boolean = opts.boolean.concat(opts.alias[key2] = opts.alias[key2] || []);
      });
      opts.string.forEach((key2) => {
        opts.string = opts.string.concat(opts.alias[key2] = opts.alias[key2] || []);
      });
      if (defaults) {
...
var require_parse = __commonJS({
  "node_modules/args/lib/parse.js"(exports2, module2) {
    "use strict";
    var path = require("path");
...
var require_example = __commonJS({
  "node_modules/args/lib/example.js"(exports2, module2) {
    "use strict";
...
var require_examples = __commonJS({
  "node_modules/args/lib/examples.js"(exports2, module2) {
    "use strict";
    module2.exports = function(list) {
      if (list.constructor !== Array) {
...
var require_help = __commonJS({
  "node_modules/args/lib/help.js"(exports2, module2) {
    "use strict";
    module2.exports = function() {
      ...
      const value2 = typeof this.config.value === "string" ? " " + this.config.value : "";
      parts.push([
        `  Usage: ${this.printMainColor(name)} ${this.printSubColor(
          optionHandle + cmdHandle + value2
        )}`,
        ""
      ]);
      for (const group in groups) {
...
var require_version = __commonJS({
  "node_modules/args/lib/version.js"(exports2, module2) {
    "use strict";
    var fs2 = require("fs");
    var path = require("path");
    function findPackage(directory) {
      const file2 = path.resolve(directory, "package.json");
      if (fs2.existsSync(file2) && fs2.statSync(file2).isFile()) {
...
var require_lib2 = __commonJS({
  "node_modules/args/lib/index.js"(exports2, module2) {
    "use strict";
...
// node_modules/object-selectors/selector.js
...
function peg$parse(input, options) {
  ...
  var peg$f0 = function(selectors) {
    return Object.assign(function union(obj, references, mode) {
      let result = selectors[0](obj, references, mode);
          ...
          for (let i = resolution.length - 1; i >= 0; i--) {
            for (let j = resolution[i].selection.length - 1; j >= 0; j--) {
              if (!hasProperty(resolution[i].target, resolution[i].selection[j])) {
                switch (mode) {
                  case MODE_STRICT:
                    throw new TypeError(`Object has no properties matching ${text()}`);
                  case MODE_LENIENT:
                    resolution[i].selection.splice(j, 1);
                }
              }
            }
      ...
      for (let item of resolution) {
        if (mode === MODE_LENIENT && item.target == null)
          ...
          if (item.target == void 0)
            throw new TypeError(`Cannot select ambiguously on ${item.target}`);
          item.selection = [];
          for (const key2 in item.target)
            if (regex.test(key2))
              item.selection.push(key2);
        }
      }
    }, { ambiguous: true });
  };
    ...
    function createSelectFunction(typeguard) {
      return function selectByType(resolution, references, mode) {
        for (let item of resolution) {
          ...
          item.selection = item.selection.filter((sel) => sel !== void 0);
        }
      };
    }
    const PRIMITIVES = ["string", 123, 123n, true, void 0, Symbol(), null];
    switch (meta) {
      case "string":
        return createSelectFunction((subject) => typeof subject !== "string");
      case "number":
        return createSelectFunction((subject) => typeof subject !== "number");
      case "bigint":
        return createSelectFunction((subject) => typeof subject !== "bigint");
      case "boolean":
        return createSelectFunction((subject) => typeof subject !== "boolean");
      case "undefined":
        return createSelectFunction((subject) => typeof subject !== "undefined");
      case "symbol":
        return createSelectFunction((subject) => typeof subject !== "symbol");
      case "null":
        return createSelectFunction((subject) => subject !== null);
      case "primitive":
        return createSelectFunction((subject) => typeof subject === "object" && subject !== null);
      case "object":
        return createSelectFunction((subject) => typeof subject !== "object" || subject === null || Array.isArray(subject));
      case "array":
        return createSelectFunction((subject) => !Array.isArray(subject));
      case "complex":
        return createSelectFunction((subject) => typeof subject !== "object" || subject === null);
      case "existent":
        return createSelectFunction((subject) => subject == void 0);
      case "nonexistent":
        return createSelectFunction((subject) => subject != void 0);
      case "unique":
          ...
          for (let i = 0; i < resolution.length; i++)
            for (let j = 0; j < resolution[i].selection.length; j++)
              for (let k = i; k < resolution.length; k++) {
                ...
                resolution[k].selection = resolution[k].selection.filter((sel) => sel !== void 0);
              }
        };
    }
  };
  var peg$f12 = function(condition) {
    return function selectByCondition(resolution, references, mode) {
      ...
      const value2 = valueFn(references);
      for (let item of resolution)
        item.selection = item.selection.filter((selectedProperty) => {
          const conditionProperties = selector(item.target[selectedProperty], references, mode).flatMap(({ target: target2, selection }) => selection.map((conditionProperty) => ({ target: target2, conditionProperty })));
          return conditionProperties.length > 0 && conditionProperties.every(({ target: target2, conditionProperty }) => operator(target2[conditionProperty], value2));
        });
    };
  };
  ...
  var peg$f18 = function(symbols) {
    return symbols.join("");
  };
  var peg$f19 = function(descriptor) {
...
// node_modules/object-selectors/applicators.js
var CollationError = class extends Error {
};
function _perform(select, fn, obj, options) {
  ...
  for (let item of resolution)
    for (let property of item.selection) {
      const value2 = fn(item.target[property], property, item.target);
      if (!options?.readonly && value2 !== item.target[property])
        item.target[property] = value2;
      result.push(value2);
    }
  if (options?.collate)
...
function compile(selector) {
  const result = peg$parse(selector);
  result.perform = (...args2) => perform(result, ...args2);
  result.get = (...args2) => get(result, ...args2);
  result.set = (...args2) => set(result, ...args2);
  return result;
}
function perform(selector, fn, obj, options) {
  if (typeof selector !== "function")
    selector = compile(selector);
  return _perform(selector, fn, obj, options);
}
function get(selector, obj, options) {
  return perform(selector, (x) => x, obj, Object.assign({}, options, { readonly: true }));
}
function set(selector, obj, value2, options) {
  return perform(selector, () => value2, obj, options);
}
...
var targetYamlStr = import_yaml.default.stringify(target, 2);
import_node_fs.default.writeFileSync(file, targetYamlStr);
